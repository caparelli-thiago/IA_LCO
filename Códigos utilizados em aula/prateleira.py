...
p = prateleira(1, False)
p.exibeProdutos()
p.mudaLado(True)
p.exibeProdutos()
p.insereProduto("Milho")
p.insereProduto("Batata")
p.insereProduto("Caneta")
p.insereProduto("Café")
p.insereProduto("Diamante")
p.exibeProdutos()
p.removeProduto("Diamante")
p.removeProduto("Café")
p.exibeProdutos()
